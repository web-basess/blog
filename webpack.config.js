...
module.exports = {
    ...
    module: {
        loaders: [//定义一系列加载器
            ...
            {test: /\.css$/, loader: ExtractTextPlugin.extract("style-loader", "css-loader",{publicPath:"../"})},                      /*css to css*/
            {test: /\.(jpg|png)(\?\S*)?$/i, loader: "url?limit=8192&name=images/[name][hash].[ext]"},  //limit=8192表示图片大小单位是k  小于这个值走内联大于这个值走外联             /*images 打包*/
            {test: /\.scss/, loader: ExtractTextPlugin.extract('style', 'css!sass',{publicPath:"../"})}                /*sass to css*/
        ]
    },
